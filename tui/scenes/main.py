...
class MainScene(Scene):
    def __init__(self, screen, _name, node):
        effects = [
            DynamicSourceCursor(screen, BlockStatusRenderer(node), 0, 0, speed=4, no_blink=True),
            DynamicSourceCursor(screen, NetworkStatusRenderer(node), 60, 0, speed=4, no_blink=True)
