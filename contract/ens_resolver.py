...
class EnsResolver(Contract):
    MAINNET='0x5FfC014343cd971B7eb70732021E26C35B744cc4'
    ...
    @classmethod
    def set_address(cls, name, address_target):
        ...
        fn = cls._contract.functions.setAddr(_namehash, HexBytes(address_target))
        return fn
