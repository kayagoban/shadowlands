...
class TokenFrame(SLFrame):
    ...
    def token_detail(self):
        self.dapp.add_sl_frame(TokenDetail(self.dapp, height=10, width=46, title=self.dapp.selected_token['name']))
...
class TokenDetail(SLFrame):
    ...
    def remove_token(self):
        self.dapp.add_sl_frame(RemoveTokenFrame(self.dapp, height=5, width=42, title='Remove Token'))
        self.close()
